...
\CommentTok{\# Triangle vertices}
\NormalTok{points }\OperatorTok{=}\NormalTok{ np.array([[}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{], [}\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{], [}\DecValTok{0}\NormalTok{, np.sqrt(}\DecValTok{3}\NormalTok{)]])}
\NormalTok{triangle }\OperatorTok{=}\NormalTok{ plt.Polygon(points, fill}\OperatorTok{=}\VariableTok{False}\NormalTok{, edgecolor}\OperatorTok{=}\StringTok{\textquotesingle{}black\textquotesingle{}}\NormalTok{, linewidth}\OperatorTok{=}\DecValTok{2}\NormalTok{)}
\NormalTok{ax.add\_patch(triangle)}

\CommentTok{\# Side labels}
\NormalTok{ax.text(}\FloatTok{0.5}\NormalTok{, }\OperatorTok{{-}}\FloatTok{0.15}\NormalTok{, }\StringTok{\textquotesingle{}a = 1\textquotesingle{}}\NormalTok{, ha}\OperatorTok{=}\StringTok{\textquotesingle{}center\textquotesingle{}}\NormalTok{, fontsize}\OperatorTok{=}\DecValTok{11}\NormalTok{)}
\NormalTok{ax.text(}\OperatorTok{{-}}\FloatTok{0.15}\NormalTok{, np.sqrt(}\DecValTok{3}\NormalTok{)}\OperatorTok{/}\DecValTok{2}\NormalTok{, }\StringTok{\textquotesingle{}b = √3\textquotesingle{}}\NormalTok{, ha}\OperatorTok{=}\StringTok{\textquotesingle{}center\textquotesingle{}}\NormalTok{, fontsize}\OperatorTok{=}\DecValTok{11}\NormalTok{, rotation}\OperatorTok{=}\DecValTok{90}\NormalTok{)}
\NormalTok{ax.text(}\FloatTok{0.6}\NormalTok{, np.sqrt(}\DecValTok{3}\NormalTok{)}\OperatorTok{/}\DecValTok{2}\NormalTok{, }\StringTok{\textquotesingle{}c = 2\textquotesingle{}}\NormalTok{, ha}\OperatorTok{=}\StringTok{\textquotesingle{}center\textquotesingle{}}\NormalTok{, fontsize}\OperatorTok{=}\DecValTok{11}\NormalTok{, rotation}\OperatorTok{={-}}\DecValTok{60}\NormalTok{)}

\CommentTok{\# Angle labels}
\NormalTok{ax.text(}\FloatTok{0.08}\NormalTok{, }\FloatTok{0.08}\NormalTok{, }\StringTok{\textquotesingle{}90°\textquotesingle{}}\NormalTok{, fontsize}\OperatorTok{=}\DecValTok{10}\NormalTok{)}
\NormalTok{ax.text(}\OperatorTok{{-}}\FloatTok{0.05}\NormalTok{, np.sqrt(}\DecValTok{3}\NormalTok{)}\OperatorTok{{-}}\FloatTok{0.15}\NormalTok{, }\StringTok{\textquotesingle{}60°\textquotesingle{}}\NormalTok{, fontsize}\OperatorTok{=}\DecValTok{10}\NormalTok{)}
\NormalTok{ax.text(}\FloatTok{0.82}\NormalTok{, }\FloatTok{0.05}\NormalTok{, }\StringTok{\textquotesingle{}30°\textquotesingle{}}\NormalTok{, fontsize}\OperatorTok{=}\DecValTok{10}\NormalTok{)}

\NormalTok{ax.set\_xlim(}\OperatorTok{{-}}\FloatTok{0.3}\NormalTok{, }\FloatTok{1.4}\NormalTok{)}
\NormalTok{ax.set\_ylim(}\OperatorTok{{-}}\FloatTok{0.3}\NormalTok{, }\FloatTok{2.1}\NormalTok{)}
...
\NormalTok{ax.set\_title(}\StringTok{\textquotesingle{}30{-}60{-}90 Triangle\textquotesingle{}}\NormalTok{, fontsize}\OperatorTok{=}\DecValTok{13}\NormalTok{)}
...
\pandocbounded{\includegraphics[keepaspectratio]{trig/basics_files/figure-pdf/cell-2-output-1.pdf}}
